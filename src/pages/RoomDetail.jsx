  ...
  return  room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      {/* Room Address */}
        ...
        <div className='max-w-3xl border-y border-gray-300 my-1.5 py-10
        text-gray-500'>
          <p>
            Guests will be allocated on the grounde floor according to Availability.
            You get a comfortable Two bedroom apartment has a tru city feeling.
            The price quoted is for two guest, at the guest slot please mark the number
            of guests to get the exact price for groupes. The Guests will be allocated
            grounded floor according to Availability. You get the comfortable two bedroom
